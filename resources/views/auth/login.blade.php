            ...
            <div class="row">
                <div class="col-md-3 center">
                    <div class="login-box">
                        ...
                        <p class="text-center m-t-md">Inicia sesión en su cuenta</p>
                        ...
                        <form class="m-t-md" method="POST" action="{{ route('login') }}">
                            ...
                            <a href="{{ route('password.update') }}" class="display-block text-center m-t-md text-sm">¿Has olvidado tu contraseña?</a>
                            <p class="text-center m-t-xs text-sm">¿No tienes una cuenta?</p>
                            <a href="register" class="btn btn-default btn-block m-t-md">Crear cuenta</a>
                        </form>
